...
public class BillsLoadStateAdapter
        extends androidx.paging.LoadStateAdapter<BillsLoadStateAdapter.LoadStateViewHolder>
{
    // Define Retry Callback
    private View.OnClickListener mRetryCallback;

    public BillsLoadStateAdapter(View.OnClickListener retryCallback) {
        // Init Retry Callback
